...
特に、製造業、サプライチェーン、社会インフラ、医療分野において、生成された未来を実運用の改善、<br>
信頼性向上、リスク低減、業務最適化へ接続する応用に関心があります。
...
学術活動<br>
Applied Soft Computing Journal など、AI・データサイエンス分野の国際論文誌における査読活動に参画。
時系列予測、異常検知、機械学習、強化学習を対象とする研究論文について、新規性、技術的妥当性、実験設計、評価指標、産業応用可能性の観点からレビューを行い、論文品質の向上および編集判断に資する改善提案を実施。
