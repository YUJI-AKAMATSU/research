...
時系列・時空間データ、視覚表現、3D空間データを対象に、時間構造解析、表現学習、潜在状態モデリングを組み合わせ、
状態把握・兆候・将来予測・意思決定までを一体的に扱う分析枠組みを研究しています。<br>

研究関心は、製造業、サプライチェーン、社会インフラ、医療などの産業応用を中心としています。
製造・医療分野における3D画像処理、ECM、SCM、業務システム、DX推進の実務経験を背景に、
...
製造業、サプライチェーン、社会インフラ、医療分野を中心に、実データを用いた共創研究を歓迎します。
...
課題設定、方法論構築、PoC検証、学会発表・論文化、実務適用可能性の評価までを対象としています。
