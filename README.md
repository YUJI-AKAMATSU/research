...
3D画像処理などが関連する重要業務のITだけでなく、ECM・SCMなどの基幹業務システムを扱う企業にて、、<br>
...
この問題意識を背景に、現場で直面する予測・判断の課題を解決するため、<br>
画像・データ・AIを統合し、データから未来を推定し意思決定へ結び付ける手法の研究へと発展させています。

また、多様な価値観や意思を協調的な意思決定へ接続することにも関心があり、<br>
...
- 時系列・時空間データ解析  
- 時間構造の解析（幾何解析 / 位相解析 / 動力学解析 / 因果解析）と関数設計  
- 表現学習（1D・2D・3D）  
- 潜在ダイナミクスモデリング／世界モデル  
- 統計的推論 / 多視点処方モデリング
...
Akamatsu, Y. “Geometric Re-embedding of Temporal Structure and Temporal Phase Alignment Analysis of Vision Transformer Attention Structures.” Meeting on Image Recognition and Understanding (MIRU 2026), Poster Presentation, 2026.
